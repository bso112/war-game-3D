...
public:
	...
	virtual HRESULT Ready_Component_Prototype(vector<IDirect3DBaseTexture9*>*	Textures);
	virtual HRESULT Ready_Component_Prototype(IDirect3DBaseTexture9*	pRawTexture);

	virtual HRESULT Ready_Component(void* pArg);

public:
	size_t	Get_TextureSize() { return m_Textures.size(); }
private:
...
public:
	...
	static CTexture* Create(LPDIRECT3DDEVICE9 pGraphic_Device, vector<IDirect3DBaseTexture9*>*	Textures);
	static CTexture* Create(LPDIRECT3DDEVICE9 pGraphic_Device, IDirect3DBaseTexture9* pRawTexture);
